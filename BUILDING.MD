...
The commands you should run to clone the Randomizer repository will vary depending on whether or not you plan to create pull requests.
...
- If you are just tinkering, run the following:
