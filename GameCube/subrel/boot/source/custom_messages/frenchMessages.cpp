...
namespace mod::customMessages
{
    ...
    MSG_BEGIN_ARRAY( skyBookCharacterFr )
        ...
        "\x21\x20\x56\x6F\x75\x73\x20\x65\x6E\x20\x61\x76\x65\x7A\x20\x63\x6F\x6C\x6C\x65\x63\x74\xE9\x20\x0A"
        MSG_COLOR(MSG_COLOR_RED)
        "%" PRIu32
        MSG_COLOR(MSG_COLOR_WHITE)
        // pour l'instant
        "\n\x70\x6F\x75\x72\x20\x6C\x27\x69\x6E\x73\x74\x61\x6E\x74"
    MSG_END();
