...
namespace mod::game_patch::bgm::bgmrando
{
    ...
    void ( *sceneChangeTrampoline )( libtp::tp::z2audiolib::z2scenemgr::Z2SceneMgr* sceneMgr,
    ...
    void initRandomBgm( rando::Randomizer* randomizer, bool set )
    {
        ...
        sceneChangeTrampoline = libtp::patch::hookFunction(
                ...
                bool param_7 )
            {
                ...
                if ( id >= 0x1000000 && id < 0x2000000 )
                {
                    ...
                    if ( found )
                    {
                        ...
                        sceneChangeTrampoline( sceneMgr,
                                               new_id,
                                               SeWave1,
                                               SeWave2,
                                               bgmSource[index_of_id].bgmWave1,
                                               bgmSource[index_of_id].bgmWave2,
                                               DemoWave,
                                               param_7 );
                    }
                    else
